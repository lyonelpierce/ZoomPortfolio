...
const OptionsMenu = () => {
  ...
  return (
    ...
    <div className="bg-[#121619] md:hidden opacity-0 transition-all ease-in-out group-hover:opacity-100 absolute bottom-0 flex justify-between items-center h-20 px-1 w-full">
      <ScrollArea className="flex flex-row">
      {/* Start Menu */}
      <ul className="flex gap-1 items-center w-full">
        <li
